...
@section('content')
	<!-- Begin page heading -->
	<h1 class="page-heading">Edit Department Page <small>Displays a form to edit department information</small></h1>
	<!-- End page heading -->
	...
	<ol class="breadcrumb default square rsaquo sm">
		...
		<li><a href="{{ URL::route('departments.show', $department['department_id']) }}">{{ $department['department_name'] }}</a></li>
		<li class="active">Edit department information</li>
	</ol>
	<!-- End breadcrumb -->
